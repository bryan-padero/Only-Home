...
class User(UserMixin, db.Model):
    ...
    sent_review = db.relationship("Review", foreign_keys="Review.reviewer_id", backref="reviewer")
    received_review = db.relationship("Review", foreign_keys="Review.reviewee_id", backref="reviewee")
